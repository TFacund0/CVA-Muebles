...
class GoogleAuthService
{
    ...
    /**
     * @param string|null $redirectUri Por defecto usa GOOGLE_REDIRECT_URI (flujo legacy con sesión).
     *                                  GoogleAuthController pasa GOOGLE_API_REDIRECT_URI para el flujo JWT,
     *                                  que necesita un callback distinto (sin sesión de PHP).
     */
    public function __construct(?string $redirectUri = null)
    {
        ...
        $this->redirectUri = $redirectUri ?? getenv('GOOGLE_REDIRECT_URI');
    }

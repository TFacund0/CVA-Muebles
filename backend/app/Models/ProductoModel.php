...
class ProductoModel extends Model 
{
    ...
    /**
     * @var bool Habilita created_at/updated_at nativos de CI4.
     */
    protected $useTimestamps = true;

    /**
     * @var bool Habilita borrado lógico nativo de CI4 vía deleted_at.
     */
    ...
    {
        // El borrado lógico de productos se filtra automáticamente vía deleted_at (useSoftDeletes).
        $builder = $this->select('productos.*, categorias.descripcion as categoria')
                    ->join('categorias', 'categorias.id_categoria = productos.categoria_id')

...
<div class="row mb-5 align-items-center g-4">
    ...
    <div class="col-lg-4 text-lg-end">
        <div id="inquiry-header-status-badge" 
             data-activos="<?= $counts['activos'] ?>" 
             data-contestados="<?= $counts['total'] - $counts['activos'] ?>" 
             class="badge bg-gold-soft text-gold px-4 py-2 rounded-pill fs-6 fw-bold border border-gold shadow-sm w-sm-100 justify-content-center">
...
<script src="<?= base_url('assets/js/admin/messages.js?v=1.0') ?>"></script>
<?= $this->endSection() ?>
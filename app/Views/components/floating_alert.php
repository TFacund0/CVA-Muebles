...
<?php if ($msg): ?>
    <div class="toast-container position-fixed bottom-0 end-0 p-4 toast-container-cva">
        <div id="liveToast" class="toast show border-0 rounded-4 shadow-lg animate-slide-up" role="alert" aria-live="assertive" aria-atomic="true" data-toast-duration="<?= $duration ?>">
            ...
            <div class="toast-body bg-white py-3 px-4 rounded-bottom-4 border-top toast-body-dashed">
                <p class="mb-0 text-muted fw-500 toast-message-text"><?= $msg ?></p>
            </div>
